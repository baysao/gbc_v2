...
_lualib() {
	...
	# else
	$SED_BIN "s#-I/usr/local/include -I/usr/include/luajit-2.1 -L/usr/local/bin -llua53#-I$DEST_BIN_DIR/openresty/luajit/include/luajit-2.1 -I/usr/include/luajit-2.1 -L$DEST_BIN_DIR/openresty/luajit/lib#g" Makefile
	# fi
	make linux
